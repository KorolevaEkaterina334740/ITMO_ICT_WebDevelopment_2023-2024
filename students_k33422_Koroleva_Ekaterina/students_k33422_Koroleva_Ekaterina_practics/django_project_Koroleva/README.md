...
**Общий** срок сдачи: **01.10.2023** (включительно) (необходимо отправить pull-реквест с работой). Вес работы в баллах – 12,5. Выполнение пунктов 1-5 - 100%. После срока сдачи максимальный бал 6.
